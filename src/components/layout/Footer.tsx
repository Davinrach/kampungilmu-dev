      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-xl font-bold text-white">Kampung Ilmu</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/books" className="hover:text-teal-400 transition">
                  Buku
                </Link>
              </li>
              <li>
          ...
          {/* Untuk Seller */}
          <div>
            <h3 className="text-white font-semibold mb-4">Untuk Seller</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <Link
              ...
              <li>
                <Link href="/seller" className="hover:text-teal-400 transition">
                  Dashboard
                </Link>
              </li>
            </ul>
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-400">
            © {new Date().getFullYear()} Kampung Ilmu. All rights reserved.
          </p>
